...
@configclass
class RecurrentPolicyCfg(InstinctRlEncoderActorCriticRecurrentCfg):
    # A7 ablation: replace feed-forward MoE policy with recurrent actor-critic.
    init_noise_std = 1.0
...
@configclass
class G1ParkourPPORunnerCfgA7Recurrent(InstinctRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 30000
    save_interval = 5000
    experiment_name = "g1_parkour_a7_recurrent"
    resume = False
    load_run = ""
    empirical_normalization = False
    policy = RecurrentPolicyCfg()
