...
@configclass
class MoEPolicyNoDepthCfg(InstinctRlActorCriticCfg):
    # A2 ablation: remove depth encoder pathway by using pure state-based policy.
...
@configclass
class G1ParkourPPORunnerCfgA2NoDepth(InstinctRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 30000
    save_interval = 5000
    experiment_name = "g1_parkour_a2_no_depth"
    resume = False
    load_run = ""
    empirical_normalization = False
    policy = MoEPolicyNoDepthCfg()
