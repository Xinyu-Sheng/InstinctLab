...
@configclass
class MoEPolicyCfgA3Moe1(InstinctRlEncoderMoEActorCriticCfg):
    init_noise_std = 1.0
    # A3 ablation: collapse MoE to a single expert.
    num_moe_experts = 1
...
@configclass
class G1ParkourPPORunnerCfgA3Moe1(InstinctRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 30000
    save_interval = 5000
    experiment_name = "g1_parkour_a3_moe1"
    resume = False
    load_run = ""
    empirical_normalization = False
    policy = MoEPolicyCfgA3Moe1()
