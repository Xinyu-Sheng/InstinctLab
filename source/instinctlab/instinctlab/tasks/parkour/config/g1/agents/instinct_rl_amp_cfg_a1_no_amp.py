...
@configclass
class AmpAlgoCfgA1NoAmp(InstinctRlPpoAlgorithmCfg):
    ...
    # A1 ablation: remove AMP reward signal.
...
@configclass
class G1ParkourPPORunnerCfgA1NoAmp(InstinctRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 30000
    save_interval = 5000
    experiment_name = "g1_parkour_a1_no_amp"
    resume = False
    load_run = ""
    empirical_normalization = False
    policy = MoEPolicyCfg()
    algorithm = AmpAlgoCfgA1NoAmp()
